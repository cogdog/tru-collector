...
The next section includes several options and instructions for installing the theme. Once set up, see the documentation of the theme options and other WordPress features. This is [now separated as it's own link here](https://github.com/cogdog/tru-collector/blob/master/README.md) but can also be viewed in a more readable format (thanks to [Docsify This](https://docsify-this.net/)).
