	...
	<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		elseif ( has_post_thumbnail() ) : ?>
			...
			<a class="featured-media" title="<?php the_title_attribute(); ?>" href="<?php the_permalink(); ?>">
				...
				<?php
				// for GIF images we use the full size, everything else, thumbnail
				$thumbnail_image_size = ( get_post(get_post_thumbnail_id())->post_mime_type == 'image/gif' ) ? 'full' : 'post-thumb';
